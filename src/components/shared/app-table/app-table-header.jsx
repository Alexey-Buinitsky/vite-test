			...
			<TableRow>
				{theads.map((thead) => {
					...
					return (
						<TableHead
							key={thead.key}
							className={`${thead.sortable ? 'table__head--sortable' : 'table__head--not-sortable'} ${isActive ? 'table__head--active' : ''}`}
						...
						>
							...
							{thead.isTooltip && 
								<div className="table__head-tooltip" title={thead.tooltip}>
